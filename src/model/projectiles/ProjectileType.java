...
public enum ProjectileType {
    BULLET(Constants.PATH_RESOURCES_SPRITES_PROJECTILES + "bullet-13x3.png", 15, 50, 10, 3, false,1,1),
    ...
    KNIFE(Constants.PATH_RESOURCES_SPRITES_PROJECTILES + "spr_spell_knife-42x32.png", 2, 50, 8, 5, false,1,1),
    SKULL(Constants.PATH_RESOURCES_SPRITES_PROJECTILES + "fire-skull-96x88.png", 1.3, 100, 8, 10, true,1,1),
    WHIRLWIND(Constants.PATH_RESOURCES_SPRITES_PROJECTILES + "whirlwind-animated-16x19.png", 2, 2000, 7, 5, true,1,1);
